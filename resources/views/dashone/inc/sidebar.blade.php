<nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic-register" aria-expanded="false" aria-controls="ui-basic">
              ...
              <div class="collapse" id="ui-basic-register">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('membersRegister')}}">Register Member</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{route('viewmembersRegister')}}">View Members</a></li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('Monthlycontributions')}}">
                <span class="menu-title">Register Contribution</span>
